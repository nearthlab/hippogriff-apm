...
void AP_MotorsOctaQuad::setup_motors()
{
    ...
    if( _flags.frame_orientation == AP_MOTORS_PLUS_FRAME ) {
        ...
        // X frame set-up
        // motor number CCW 1 ~ 4, 5 ~ 8 + 위 아래 쿼드로 날 수 있게 CCW, CW, 번갈아 셋팅.
        ...
        add_motor(AP_MOTORS_MOT_6,  -45, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  6);
        add_motor(AP_MOTORS_MOT_7, -135, AP_MOTORS_MATRIX_YAW_FACTOR_CW, 7);
        add_motor(AP_MOTORS_MOT_8,  135, AP_MOTORS_MATRIX_YAW_FACTOR_CCW,  8);
    }
}
